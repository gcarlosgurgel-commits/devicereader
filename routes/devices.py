...
from models import DeviceGenerate
from database.database import get_db
from database.models import DeviceTable
...
def devices_generate(data: DeviceGenerate, db: Session = Depends(get_db), token: str = Depends(oauth_scheme)):
    try:
